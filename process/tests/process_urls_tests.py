...
class ProcessUrlsTest(TestCase):
    ...
    def test_process_register_url_is_correct(self):
        ...
        self.assertEqual(url_register, '/processo/registrar/')

    def test_process_detail_url_is_correct(self):
        url_detail = reverse('process:detail', kwargs={'pk': 1})
        self.assertEqual(url_detail, '/processo/detalhes/1/')

    def test_process_delete_url_is_correct(self):
        url_delete = reverse('process:delete', kwargs={'pk': 1})
